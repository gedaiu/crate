    ...
    .post("/items")
      .send(data)
        ...
        .end((Response response) => {
          ...
          exists(parentFile).should.be.equal(true).because("The parent file should be created");
          exists(childFile).should.be.equal(true).because("The child file should be created");
